      ...
      <div className="container mx-auto p-8 mb-8 bg-white">
        ...
        <section className="text-center mb-12">
          <h1 className="font-bold text-4xl md:text-5xl">
            Horizon <span className="text-red-500">Court</span>
          </h1>
        ...
        <section className="flex flex-col md:flex-row items-center mb-12">
          ...
          <div className="w-full md:w-1/2 p-4">
            <h2 className="text-2xl font-semibold mb-4">About Horizon <span className="text-red-500">Court</span></h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-700"><span className="text-blue-500">ACTUAL PRICE:</span> N8M For 500 SQM</p>
              <p className="text-gray-700"><span className="text-blue-500">PROMO PRICE:</span> N6M For 300 SQM</p>
            </div>
            {/* Landmarks */}
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
            ...
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-700">
              {"Site inspections take place every weekday & Saturday's at 10AM."}</p>
            </div>
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
