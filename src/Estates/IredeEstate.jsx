        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <p className="text-gray-700"><span className="text-blue-500">ACTUAL PRICE: </span>N7M For 464 SQM</p>
              <p className="text-gray-700"><span className="text-blue-500">BONUS PRICE: </span>N4.5M For 464 SQM</p>
            </div>
            {/* Landmarks */}
            <div className="p-6 border rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
